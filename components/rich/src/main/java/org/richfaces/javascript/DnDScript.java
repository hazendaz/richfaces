...
public abstract class DnDScript implements ScriptWithDependencies {
    ...
    static {
        ...
        BASE_RESOURCES.add(new ResourceKey("widgets/mouse.js", "com.jqueryui"));
        BASE_RESOURCES.add(new ResourceKey("widgets/draggable.js", "com.jqueryui"));
        BASE_RESOURCES.add(new ResourceKey("widgets/droppable.js", "com.jqueryui"));
    }
